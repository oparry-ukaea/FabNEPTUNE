...
def init_run_analyse_campaign(work_dir=None, sampler_inputs_dir=None , inpt=None):
    ...
    campaign_db = db.CampaignDB(location=db_location)
    campaign_db.relocate(new_path=campaign_work_dir, campaign_name=campaign_params['campaign_name'])
    ...
    if campaign_params['sampler_name'] == 'SCSampler':
        analysis = uq.analysis.SCAnalysis(
            ...
            qoi_cols=["F1-press_L", "F1-visc_L", "F1-total_L", "F2-press_L", "F2-visc_L", "F2-total_L",
